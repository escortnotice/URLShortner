...
public class URLInfoService {
	...
	/*
	 * 1. check if the long url exists in db
	 * 2. if no entry found then get a short url generated
	 * 3. save it in the db
	 */
	 ...
	 * If yes, 
	 *  -push the url accessed and the timestamp of its access to the queue
	 *  -then  return the short url
	 * 
